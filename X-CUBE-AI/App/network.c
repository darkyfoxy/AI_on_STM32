...
#define AI_NETWORK_MODEL_SIGNATURE     "2d2852aff0400614120425837af03d7f"
...
#define AI_TOOLS_DATE_TIME   "Mon Nov  8 14:38:56 2021"
...
AI_STATIC ai_array dense_3_input_output_array;   /* Array #0 */
...
AI_STATIC ai_tensor dense_3_input_output;   /* Tensor #0 */
...
AI_ARRAY_OBJ_DECLARE(
  dense_3_input_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  dense_3_input_output, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 784, 1, 1), AI_STRIDE_INIT(4, 4, 4, 3136, 3136),
  1, &dense_3_input_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_3_input_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 1600, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &dense_3_input_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    dense_1_output_array.data = AI_PTR(activations + 800);
    dense_1_output_array.data_start = AI_PTR(activations + 800);
    nl_1_nl_output_array.data = AI_PTR(activations + 0);
    nl_1_nl_output_array.data_start = AI_PTR(activations + 0);
    dense_2_output_array.data = AI_PTR(activations + 800);
    dense_2_output_array.data_start = AI_PTR(activations + 800);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_0_bias_array.data = AI_PTR(weights + 627200);
    dense_0_bias_array.data_start = AI_PTR(weights + 627200);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 628000);
    dense_1_weights_array.data_start = AI_PTR(weights + 628000);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 788000);
    dense_1_bias_array.data_start = AI_PTR(weights + 788000);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 788800);
    dense_2_weights_array.data_start = AI_PTR(weights + 788800);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights + 796800);
    dense_2_bias_array.data_start = AI_PTR(weights + 796800);
  }
